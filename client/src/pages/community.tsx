      ...
      <div className="space-y-8 pb-10">
        ...
        {filteredVideos.length === 0 ? (
          <div className="text-center py-20 border-2 border-dashed rounded-xl">
            ...
            <p className="text-muted-foreground mt-1">Tente buscar com outros termos ou adicione um novo vídeo.</p>
          </div>
        ) : (
            ...
            {filteredVideos.map((video) => (
              <Card key={video.id} className="overflow-hidden flex flex-col hover:shadow-md transition-shadow">
                <div className="aspect-video bg-black relative group">
                  {video.videoUrl.includes("embed") || video.videoUrl.includes("youtube") ? (
                     <iframe 
                ...
                <CardHeader className="p-4 pb-2">
                  ...
                  <div className="flex items-center gap-2 mt-2">
                    <Avatar className="h-6 w-6">
                      ...
                      <AvatarFallback>{video.authorName.charAt(0)}</AvatarFallback>
                    </Avatar>
