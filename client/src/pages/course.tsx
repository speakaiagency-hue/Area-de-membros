...
export default function CoursePlayer() {
  ...
  useEffect(() => {
    if (course && course.modules.length > 0 && course.modules[0].lessons.length > 0 && !activeLesson) {
                        ...
                        {module.lessons.map((lesson) => {
                          ...
                          return (
                            ...
                            >
                              <div className={cn(
                                "shrink-0",
                                isDone ? "text-green-500" : (isActive ? "text-primary" : "text-muted-foreground/50")
                              )}>
                                {isDone ? <CheckCircle className="h-4 w-4" /> : <PlayCircle className="h-4 w-4" />}
                              </div>
